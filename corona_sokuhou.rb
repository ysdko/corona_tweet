...
if doc.css('#main_content > div.detail_free > p:nth-child(4) > a').text != previous
  kanja = doc.css('#main_content > div.detail_free > p:nth-child(4) > a').text
	detail =  doc.xpath('//*[@id="main_content"]/div[1]/p[4]/text()')
